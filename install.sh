...
#  Supports Python (primary) and Rust (opt‑in) builds.
#
...
# ── phase 6: shell helpers (optional) ────────────────────────
...
echo "    Run \`llm providers\` to see available provider profiles."
echo "    Run \`llm provider models\` to list models."
echo ""
