...
- Pressing Enter on an incomplete `llm-session` slash command now applies and
  executes the selected completion, defaulting to the first candidate. Tab
  remains available when the expanded command should be edited before running.
